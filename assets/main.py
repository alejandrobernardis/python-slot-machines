...
__project_name__ = u'SMAMB'
__project_full_name__ = u'Slot Machines'
__project_owner__ = u'Alejandro M. Bernardis'
__project_author__ = u'Alejandro M. Bernardis'
__project_version__ = (1, 0, 0, 'dev', 0)
...
from  slots.security.sessions import ClientFactory
