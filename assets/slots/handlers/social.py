...
from  slots.common.utils import week_range
from  slots.handlers.base import BaseHandler, ignore_regex
...
class SocialShareBonusHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile = self.db_social.share.bonus.find_one(profile_query)
...
class SocialShareBonusBalanceHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile = self.db_social.share.bonus.find_one({
...
class SocialSendGiftHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile_reset = False
            profile_query = self.get_query_with_lowlogic(fbuid=fbuid)
            profile = self.db_social.send.gift.find_one(profile_query)
...
class SocialSendGiftBalanceHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile = self.db_social.send.gift.find_one({
                'fbuid': fbuid, 'today': today}) or {}
...
class SocialRequestGiftHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile_reset = False
            profile_query = self.get_query_with_lowlogic(fbuid=fbuid)
            profile = self.db_social.request.gift.find_one(profile_query)
...
class SocialRequestGiftBalanceHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile = self.db_social.request.gift.find_one({
                'fbuid': fbuid, 'today': today}) or {}
...
class SocialInviteHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile_reset = False
            profile_query = self.get_query_with_lowlogic(fbuid=fbuid)
            profile = self.db_social.invite.find_one(profile_query)
...
class SocialInviteBalanceHandler(BaseHandler):
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            profile = self.db_social.invite.find_one({
